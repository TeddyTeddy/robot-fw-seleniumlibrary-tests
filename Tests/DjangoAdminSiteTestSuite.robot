...
Create "Blog Editors" Group
    ...
    Add Group With Permissions  group_name=blog_editors     permissions=${BLOG_EDITORS_PERMISSIONS}

Create "Group Editors" Group
    Go To Admin Main Page
    Click On Add Group Button  # opens add_group_page
    Verify Add Group Page
    Add Group With Permissions  group_name=group_editors     permissions=${GROUP_EDITORS_PERMISSIONS}
